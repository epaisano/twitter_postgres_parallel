...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/epaisano/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/epaisano/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/epaisano/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/epaisano/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/epaisano/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/epaisano/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |

In this assignment, you will learn how to load data into postgress much faster using two techniques:
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |         1m53.736s         |        0m:17.61s          | 
| `pg_normalized_batch`  |         3m1.908s          |        0m:16.85s          | 
| `pg_denormalized`      |         0m17.217s         |        0m:04.03s          | 
